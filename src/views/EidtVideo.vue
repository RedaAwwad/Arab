...
export default {
  ...
  mounted() {
    ...
    localStorage.setItem("ViedoID", id);
  },
  ...
  methods: {
    ...
    addVideo(e) {
      ...
      dataForm.append("video_id", localStorage.getItem("ViedoID"));
      if (this.form.type) {
      ...
      this.axios
        .post(
          "https://dashboard.arabicreators.com/api/update_video",
          dataForm,
          {
            headers: {
