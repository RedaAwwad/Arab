  ...
  <div class="aboutUs" style="padding-top: 20px !important">
    <div class="container text-center pt-4">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>الاسئلة الشائعة</el-breadcrumb-item>
      </el-breadcrumb>
      <h1 style="padding-top: 50px !important">الاسئلة الشائعة</h1>
      <div class="content">
        <div class="row">
...
export default {
  ...
  mounted() {
    ...
    Vue.axios
      .get("https://dashboard.arabicreators.com/api/faqs",{
          headers: {
