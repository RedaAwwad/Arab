  ...
  <div class="aboutUs" style="padding-top: 20px !important">
    <div class="container text-center pt-4">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>ضمان الحقوق</el-breadcrumb-item>
      </el-breadcrumb>
      <h1 style="padding-top: 50px !important">ضمان الحقوق</h1>
      <div class="content">
...
export default {
  ...
  mounted() {
    ...
    Vue.axios
      .get("https://dashboard.arabicreators.com/api/rights_guarantee")
      .then((res) => {
