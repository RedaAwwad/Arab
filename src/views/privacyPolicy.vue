  ...
  <div class="aboutUs" style="padding-top: 20px !important">
    <div class="container text-center pt-4">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>سياسة الخصوصية</el-breadcrumb-item>
      </el-breadcrumb>
      <h1 style="padding-top: 50px !important">سياسة الخصوصية</h1>
      <div class="content">
...
export default {
  ...
  mounted() {
    ...
    Vue.axios
      .get("https://dashboard.arabicreators.com/api/privacy_policy")
      .then((res) => {
